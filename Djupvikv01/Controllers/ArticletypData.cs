...
public List<ArticletypModel> hamtaArtikeltyp()
{
List<ArticletypModel> artyplist = new List<ArticletypModel>();

using (SqlConnection connection = new SqlConnection(connectionString))
{
string sqlQuery = "SELECT * FROM  artikeltyp";
...
while (lasIn.Read())
{
ArticletypModel artyp = new ArticletypModel();
artyp.id = lasIn.GetInt32(0);
artyp.artikeltyp = lasIn.GetString(1);
artyplist.Add(artyp);
}}}
return artyplist;
}
...
public ArticletypModel hamtaDetailUsers(int id)
{
...
ArticletypModel article = new ArticletypModel();
if (lasIn.HasRows)
{
while (lasIn.Read())
{
...
public int CreateOrUpdateUsers(ArticletypModel arModel)
{
using (SqlConnection connection = new SqlConnection(connectionString))
{
...
// Search for
internal List<ArticletypModel> FindUsers(string keyword)
{
List<ArticletypModel> dataList = new List<ArticletypModel>();
// Access the database
using (SqlConnection connection = new SqlConnection(connectionString))
{
